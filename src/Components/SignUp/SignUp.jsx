...
function SignUp() {
  ...
  return (
   ...
   <div className='flex justify-center'>
     <div className='p-3  justify-center rounded-4xl '>Have an account? <Link to="/login" className='font-bold text-gradient-to-t from-gray-500 via-gray-750 to-gray-900'>Log In</Link></div>
